    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">{{ __("WELCOME TO EDIT TODO ")}}<a href="{{url('/home')}}">HOME</a></div>
...
<label> Title </label>
<input type="text" class="form-control" name="title" value="{{$todo->title}}" placeholder="Enter the Title">
</div>
<div class="form-group">
<label> Body </label>
